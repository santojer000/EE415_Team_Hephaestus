#ifndef FFT_FLOAT_TYPE_H
#define FFT_FLOAT_TYPE_H
//#include <math.h>

// List of functions
void create_indeces(int *indeces);
void bit_reversal_indeces(int *forward_index, int *reversed_index);
void bit_reversal(float *samples_in, float *samples_out, int *reversed_index, int sample_size);
short FFT(long m, float *x, float *y);
short IFFT(long m, float *x, float *y);
void magnitude(unsigned int size, float *magnitude, float *real, float *complex);
float max_(float *input_array, unsigned int size);
...
const unsigned int INDEX_BIT_LENGTH = 10;
...
*  Input:       float pointer, float pointer, int pointer, int	 *
*  Output:      void                                                *
*  See Funcs:   N/A                                                 *
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*  Function:    FFT									             *
*  Input:       long, float pointer, float pointer				 *
*  Output:      Boolean (1/0)                                       *
*  See Funcs:   N/A                                                 *
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*  Function:    magnitude								             *
*  Input:       unsigned int, float pointer, float pointer,		 *
*				 float pointer										 *
*  Output:      void                                                *
*  See Funcs:   N/A                                                 *
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*  Function:    max									             *
*  Input:       float pointer, unsigned int						 *
*  Output:      float                                              *
*  See Funcs:   N/A                                                 *
*  Description: Function that calculates the max value an array.	 *
*					- input array = array of floats				 *
*					- size = size of array							 *
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 float max_(float *input_array, unsigned int size)
{
	...
	for (i = 0; i < size - 1; i++)
	{
        ...
        if (max_value < input_array[i]) max_value = input_array[i];
	}
...
*  Input:       unsigned int, float pointer						 *
*  Output:      void                                                *
*  See Funcs:   N/A                                                 *
...
{
	int i = 0;
	float max_val = max_(samples, sample_size);
